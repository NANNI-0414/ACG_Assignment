...
void renderScene(void)
{
    ...
    //이 부분은 B-spline이더라도 Tessellation Shader를 사용하기 때문에 안 바뀔 거 같음
    //근데 control point의 개수가 달라지면 4가 아닌 다른 숫자가 들어갈 거 같음.
...
{
    //pointVertices[]에서 control point가 더 필요할 수도
    ...
    glutCreateWindow("B-Spline Tessellation");
    ...
    //3. 
    GLuint programID = LoadShaders("VertexShader5_3.txt", "TessControlShader5_3.txt"
        , "TessEvaluationShader5_3.txt", "FragmentShader5_3.txt");
