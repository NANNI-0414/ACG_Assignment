...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("B-Spline Tessellation Non-Uniform");
    ...
    //3. 
    GLuint programID = LoadShaders("VertexShader5_2.txt", "TessControlShader5_2.txt"
        , "TessEvaluationShader5_2.txt", "FragmentShader5_2.txt");
