...
int main(int argc, char** argv)
{
    ...
    //3. 
    GLuint programID = LoadShaders("VertexShader6_1.txt", "TessControlShader6_1.txt"
        , "TessEvaluationShader6_1.txt", "FragmentShader6_1.txt");
